...
var routes = [
    ...
    { path: 'products/:id', component: __WEBPACK_IMPORTED_MODULE_9__products_products_component__["a" /* ProductsComponent */] }
];
...
var ProductsComponent = (function () {
    function ProductsComponent(route) {
        ...
        route.params.subscribe(function (params) {
            _this.id = params['id'];
            _this.currProduct = _this.getProductById(_this.id);
        });
    }
    ProductsComponent.prototype.ngOnInit = function () {
    };
    ProductsComponent.prototype.getProductById = function (id) {
        if (id) {
            id = id.toLocaleLowerCase();
            return this.products.find(function (el) { return el.title.toLowerCase() === id; });
        }
        else {
            return null;
        }
